    ...
    def _show_how_to(self):
        ...
        if IMPREST_ENABLED:
            ...
            full_tool_help = (
                ...
                "keeps Debit and Credit values in their original columns, makes Debit "
                "negative and Credit positive, adds totals and Transaction Number "
                "counts, and checks opening + debit + credit "
                "against closing</li>"
