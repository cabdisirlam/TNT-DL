...
start "" cmd /c "ping 127.0.0.1 -n 3 >nul & del /f /q \"%INSTALL_DIR%\uninstall.cmd\" >nul 2>&1 & rmdir /s /q \"%INSTALL_DIR%\" >nul 2>&1 & rmdir /s /q \"%APPDATA_SETTINGS_DIR%\" >nul 2>&1 & rmdir /s /q \"%LOCALAPPDATA_SETTINGS_DIR%\" >nul 2>&1 & rmdir /s /q \"%HOME_SETTINGS_DIR%\" >nul 2>&1"
exit /b 0
